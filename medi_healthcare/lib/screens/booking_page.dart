...
import 'package:medi_healthcare/components/custom_appbar.dart';
import 'package:medi_healthcare/main.dart';
import 'package:medi_healthcare/models/booking_datetime_converted.dart';
          ...
          _isWeekend
              ? SliverToBoxAdapter(
                  child: Container(
                    ...
                    child: const Text(
                      'Weekend is not available, please selected another date',
                      style: TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.bold,
                        color: Colors.grey,
