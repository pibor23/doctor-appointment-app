...
import 'package:medi_healthcare/components/appointment_card.dart';
import 'package:medi_healthcare/components/doctor_card.dart';
...
class _HomePageState extends State<HomePage> {
      ...
      if(response != null){
        setState(() {
          ...
          for(var doctorData in user['doctor']){
            ...
            if (doctorData['appointmnet'] !=null){
              doctor = doctorData;
            }
          }
  ...
  Widget build(BuildContext context) {
    Config().init(context);
    return Scaffold(
      //if user is empty the return progress indicator
      body: user.isEmpty ? 
      const Center(
